...
var DragListener = /** @class */ (function () {
    ...
    DragListener.prototype.updateAutoScroll = function (ev) {
        ...
        if (bounds) {
            ...
            // translate vertical closeness into veloadmission_date.
            // mouse must be completely in bounds for veloadmission_date to happen.
            ...
            // translate horizontal closeness into veloadmission_date
    ...
    DragListener.prototype.setScrollVel = function (topVel, leftVel) {
        ...
        // if there is non-zero veloadmission_date, and an animation loop hasn't already started, then START
...
var HelperRenderer = /** @class */ (function () {
    ...
    HelperRenderer.prototype.renderEventDraggingFootprints = function (eventFootprints, sourceSeg, isTouch) {
        this.renderEventFootprints(eventFootprints, sourceSeg, 'fc-dragging', isTouch ? null : this.view.opt('dragOpaadmission_date'));
    };
    HelperRenderer.prototype.renderEventResizingFootprints = function (eventFootprints, sourceSeg, isTouch) {
        this.renderEventFootprints(eventFootprints, sourceSeg, 'fc-resizing');
    };
    HelperRenderer.prototype.renderEventFootprints = function (eventFootprints, sourceSeg, extraClassNames, opaadmission_date) {
        var segs = this.component.eventFootprintsToSegs(eventFootprints);
        ...
        if (opaadmission_date != null) {
            for (i = 0; i < segs.length; i++) {
                segs[i].el.css('opaadmission_date', opaadmission_date);
            }
        }
        ...
        var dragListener = this.dragListener = new HitDragListener_1.default(view, {
            ...
            interactionStart: function (ev) {
                ...
                mouseFollower = new MouseFollower_1.default(seg.el, {
                    ...
                    parentEl: view.el,
                    opaadmission_date: dragListener.isTouch ? null : _this.opt('dragOpaadmission_date'),
    ...
    MouseFollower.prototype.getEl = function () {
        ...
        if (!el) {
            el = this.el = this.sourceEl.clone()
                ...
                opaadmission_date: this.options.opaadmission_date || '',
