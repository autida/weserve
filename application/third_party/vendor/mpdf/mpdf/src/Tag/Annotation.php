...
class Annotation extends Tag
{
	...
	public function open($attr, &$ahtml, &$ihtml)
	{
		...
		if (isset($attr['OPAadmission_date']) && $attr['OPAadmission_date'] > 0 && $attr['OPAadmission_date'] <= 1) {
			$objattr['OPAadmission_date'] = $attr['OPAadmission_date'];
		} elseif ($this->mpdf->annotMargin) {
			$objattr['OPAadmission_date'] = 1;
		} else {
			$objattr['OPAadmission_date'] = $this->mpdf->annotOpaadmission_date;
		}
		if (isset($attr['COLOR'])) {
