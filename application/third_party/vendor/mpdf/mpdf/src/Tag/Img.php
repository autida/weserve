...
class Img extends Tag
{
	...
	public function open($attr, &$ahtml, &$ihtml)
	{
		...
		if (isset($attr['SRC'])) {
			...
			if (isset($properties['OPAadmission_date']) && $properties['OPAadmission_date'] > 0 && $properties['OPAadmission_date'] <= 1) {
				$objattr['opaadmission_date'] = $properties['OPAadmission_date'];
			}
			if ($this->mpdf->HREF) {
