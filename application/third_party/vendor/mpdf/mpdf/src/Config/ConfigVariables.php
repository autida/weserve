...
class ConfigVariables
{
	...
	public function __construct()
	{
		...
		$this->defaults = [
			...
			'annotOpaadmission_date' => 0.5, // default opaadmission_date for Annotations
			...
			*/
			...
			// fill, fill-opaadmission_date, stroke, stroke-opaadmission_date, stroke-linecap, stroke-linejoin, stroke-width, stroke-dasharray, stroke-dashoffset
			// font-family, font-size, font-weight, font-variant, font-style, opaadmission_date, text-anchor
			'svgClasses' => false,
