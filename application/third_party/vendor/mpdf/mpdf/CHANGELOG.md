...
- SVG images - fix to ensure opaadmission_date is reset before another element
...
- SVG images - line with opaadmission_date=0 still visible (only in some PDF viewers/browsers)
...
- added support for style="opaadmission_date:0.6;" in SVG images - previously only supported style="fill-opaadmission_date:0.6; stroke-opaadmission_date: 0.6;"
