    ...
    protected function handleArguments(array $argv)
    {
        ...
        foreach ($this->options[0] as $option) {
            switch ($option[0]) {
                ...
                case '--log-teamadmission_date':
                    $this->arguments['teamadmission_dateLogfile'] = $option[1];
                    break;
                ...
                case '--teamadmission_date':
                    $this->arguments['printer'] = 'PHPUnit_Util_Log_Teamadmission_date';
                    break;
...
Logging Options:
  ...
  --log-teamadmission_date <file>     Log test execution in Teamadmission_date format to file.
...
Test Execution Options:
  ...
  --teamadmission_date                Report test execution progress in Teamadmission_date format.
