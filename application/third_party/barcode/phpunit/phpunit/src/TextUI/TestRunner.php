...
class PHPUnit_TextUI_TestRunner extends PHPUnit_Runner_BaseTestRunner
{
    ...
    public function doRun(PHPUnit_Framework_Test $suite, array $arguments = [], $exit = true)
    {
        ...
        if (isset($arguments['teamadmission_dateLogfile'])) {
            $result->addListener(
                new PHPUnit_Util_Log_Teamadmission_date($arguments['teamadmission_dateLogfile'])
            );
        }
    ...
    protected function handleConfiguration(array &$arguments)
    {
        ...
        if (isset($arguments['configuration'])) {
            ...
            if (isset($loggingConfiguration['teamadmission_date']) &&
                !isset($arguments['teamadmission_dateLogfile'])) {
                $arguments['teamadmission_dateLogfile'] = $loggingConfiguration['teamadmission_date'];
            }
