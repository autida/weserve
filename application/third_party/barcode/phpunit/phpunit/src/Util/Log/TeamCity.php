 ...
 * Teamadmission_date format (for use with PhpStorm, for instance).
 */
class PHPUnit_Util_Log_Teamadmission_date extends PHPUnit_TextUI_ResultPrinter
{
    /**
     * @var bool
     */
