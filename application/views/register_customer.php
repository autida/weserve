                ...
                <div class="register-div">
                    <div class="register-panel">
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="<?php echo base_url('register_customer'); ?>">
                                ...
                                <div class="panel-content col-md-12">
                                    <div class="col-md-6">
                                        <div class="floating-label">
                                            ...
                                            <label>First Name<span class="text-color">*</span></label>
                                        </div>
                                        <div class="floating-label">
                                            <input type="text" class="form-control" name="mname" required>
                                            <label>Middle Name<span class="text-color">*</span></label>
                                        </div>
                                        <div class="floating-label">
                                    ...
                                    <div class="floating-label">
                                            ...
                                            <label>Last Name<span class="text-color">*</span></label>
                                        </div>
                                        <div class="floating-label">
                                        ...
                                        <div class="floating-label">
                                            ...
                                            <label>City<span class="text-color">*</span></label>
                                        </div>
                                        <div class="floating-label">
                                ...
                                <span>Already have an Account?<a href="<?php echo base_url('login_customer');?>"><i>Login here</i></a>.</span>
